...
export default function Contact() {
  const MySwal = withReactContent(
    Swal.mixin({
      customClass: {
        confirmButton: "btn btn-orange swal-btn",
      },
  ...
  const [formData, setFormData] = React.useState({ email: "", body: "" });
  ...
  const sendEmail = async (e) => {
    ...
    // const user = formData;
    // console.log(user);
    // const res = await axios.put("https://reqres.in/api/users", user);
    // console.log(res);
    // setIsLoading(false);
    // clearForm();
  };
  ...
  return (
    <div className="container-fluid position-relative overflow-hidden">
      ...
      /> */}
      <img
        className="contact-path2"
        src={require("../../assets/images/path2.png")}
        alt=""
      />
      <img
        className="contact-shapes contact-triangle"
        src={require("../../assets/images/triunghiuri.webp")}
        alt=""
      />
      <img
        className="contact-shapes contact-wave d-none d-md-block"
        src={require("../../assets/images/waves.webp")}
        alt=""
      />
      {/* <img
        className="contact-shapes contact-squares"
        src={require("../../assets/images/patrat.webp")}
        alt=""
      /> */}
      <img
        className="contact-shapes contact-circles"
        ...
        <div className="row g-5 w-100">
          <div className="col-12 col-md-6 mb-3">
            <div data-aos="zoom-in-up" data-aos-once className="row mb-3">
              <h3 className="display-5 text-orange">
                Send me an email! (REQRES.IN)
              </h3>
            </div>
          ...
          <div className="col-12 col-md-6 text-center p-0 mb-5">
            ...
            >
              <h4 className="fs-5">
                ...
                <a
                  href="https://www.linkedin.com/in/argel-miralles-198559179/"
